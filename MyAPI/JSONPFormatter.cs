...
namespace MyAPI
{
    ...
    //entire class taken from: http://weblog.west-wind.com/posts/2012/Apr/02/Creating-a-JSONP-Formatter-for-ASPNET-Web-API
    /// <summary>
    ...
    public class JSONPFormatter : JsonMediaTypeFormatter
    {
        ...
        private string GetJsonCallbackFunction(HttpRequestMessage request)
        {
            ...
            try
            {
                ...
                queryVal = query[this.JsonpParameterName];
            }
            catch { }
